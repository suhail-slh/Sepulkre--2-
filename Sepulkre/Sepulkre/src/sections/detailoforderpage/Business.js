...
export default function Business() {
    ...
    return (
      <>
        <Helmet>
          <title> Business Storage| Sepulkre </title>
        </Helmet>
  
        <Typography variant="h4" align="center" sx={{ mb: 5 }}>
        <strong style={{  color: "#f46424" }}>BUSINESS STORAGE</strong>
        </Typography>
        <Grid>
        <Typography variant="h6" sx={{ mb: 5 }}>
        For the safe and secure personal storage space of any Business/Office belongings, Sepulkre offers storage services for all your needs.
        </Typography>
       </Grid>
